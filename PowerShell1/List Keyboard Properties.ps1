...
$colItems = get-wmiobject -class "Win32_Keyboard" -namespace "root\CIMV2" `
...
foreach ($objItem in $colItems) {
      ...
      write-host "Layout: " $objItem.Layout
      write-host "Name: " $objItem.Name
      write-host "Number Of Function Keys: " $objItem.NumberOfFunctionKeys
