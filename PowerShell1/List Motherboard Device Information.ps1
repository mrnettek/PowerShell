...
foreach ($objItem in $colItems) {
      ...
      write-host "Primary Bus Type: " $objItem.PrimaryBusType
      write-host "Revision Number: " $objItem.RevisionNumber
      write-host "Secondary Bus Type: " $objItem.SecondaryBusType
